        ...
        <div className="mt-48 mb-48 bg-slateblue rounded-lg h-auto lg:p-12 md:p-12 sm:p-6 content-around">
          <div className="flex lg:flex-row md:flex-col sm:flex-col lg:gap-20 md:gap-10 sm:gap-6">
            <div className="basis-2/4">
              <h2 className="font-black text-midnight xl:text-5xl lg:text-4xl md:text-5xl sm:text-7xl lg:mt-4 antialiased">
                Youth Climbing Club
              </h2>
              ...
              <h6 className="mt-8 mb-1 font-bold xl:text-2xl lg:text-2xl md:text-3xl sm:text-2xl text-midnight">
                Weekend&apos;s
              </h6>
              <p className="font-bold text-midnight xl:text-lg md:text-2xl sm:text-base">
